...
if __name__ == '__main__':
    ...
    if ggi:
        ...
        model = PPO2_GGI(GGIMlpPolicy, env, gamma=args.gamma, verbose=0, learning_rate=args.alpha, cliprange=args.clip_range)
    else:
        from stable_baselines import PPO2
        from stable_baselines.common.policies import MlpPolicy
        model = PPO2(MlpPolicy, env, gamma=args.gamma, verbose=0, learning_rate=args.alpha, cliprange=args.clip_range)
