...
def Deri_GGI(policy_gradient, averaged_states_value, reward_n, weight):
    """
    Returns the Element wise Multiplication of ordered omega vector and  policy gradient loss
    
    :params policy_gradient: (Tensorflow Tensor) Policy gradient loss
    :params averaged_states: To order the omega weights
    :params reward_n: # of objectives to solve (# of reward components)
...
def discount_with_dones(rewards, dones, gamma, reward_n):
    """
